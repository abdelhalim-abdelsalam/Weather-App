  ...
  <div class="container" style="height: 100vh">
    <div class="row p-5 h-100">
      ...
      >
        ...
        <div
          class="w-100 bg-dark text-light rounded shadow blur d-flex flex-column justify-content-around"
...
export default {
  ...
  async mounted() {
    if (this.$route.query.city == undefined || this.$route.query.city == null) {
      ...
      await axios
        .get(
          "https://api.openweathermap.org/data/2.5/weather?q=" +
            city +
            "&appid=2fea056e81dc025ce191171ec72b9ce3" +
      ...
      await axios
        .get(
          "https://api.openweathermap.org/data/2.5/forecast?lat=52.409538&lon=16.931992&exclude=current,minutely,daily,alerts&appid=2fea056e81dc025ce191171ec72b9ce3" +
            "&units=metric"
        )
        .then((response) => {
